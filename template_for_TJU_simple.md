...
theme: gaia
paginate: true
footer: 'Reported by FuYanjie 2021-09-18'
style: | 
...
section {
  background-image:url('/Users/fuyanjie/Desktop/PG/TJU elements.png/fm-simple.png');
...
section{
  background-image:url('/Users/fuyanjie/Desktop/PG/TJU elements.png/bg-simple.png');
  background-size:cover;
  position: absolute;
  }
