...
section {
  background-image:url('/Users/fuyanjie/Desktop/PG/TJU elements.png/fm-blue.png');
...
section{
  background-image:url('/Users/fuyanjie/Desktop/PG/TJU elements.png/bg-blue.png');
  background-size:cover;
  position: absolute;
  }
